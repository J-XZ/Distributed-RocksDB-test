...
// PerfContextByLevel
    struct PerfContextByLevel {
        ...
        // total number of user key returned (only rocksdb_include keys that are found, does
        // not rocksdb_include keys that are deleted or merged without a final put
