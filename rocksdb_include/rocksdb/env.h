...
// including data loss, unreported corruption, deadlocks, and more.
    ...
    public:
        ...
        // The names are relative to "dir", and shall never rocksdb_include the
        // names `.` or `..`.
        ...
        // result.
        // The name attributes are relative to "dir", and shall never rocksdb_include the
        // names `.` or `..`.
        // Original contents of *results are dropped.
        // Returns OK if "dir" exists and "*result" contains its children.
        //         NotFound if "dir" does not exist, the calling process does not have
        ...
        // Rename file my_code to target.
        virtual Status RenameFile(const std::string &src,
                                  const std::string &target) = 0;

        // Hard Link file my_code to target.
        virtual Status LinkFile(const std::string & /*my_code*/,
