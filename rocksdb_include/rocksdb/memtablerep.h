...
// is requested.
//
// Users can implement their own memtable representations. We rocksdb_include three
// types built in:
...
namespace ROCKSDB_NAMESPACE {
    ...
    public:
        ...
        // a Seek might only rocksdb_include keys with the same prefix as the target key.
