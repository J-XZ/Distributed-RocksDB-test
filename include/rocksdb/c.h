...
rocksdb_wal_iter_get_batch(const rocksdb_wal_iterator_t *iter, uint64_t *seq);
...
extern ROCKSDB_LIBRARY_API void rocksdb_set_options_cf(
        rocksdb_t *db, rocksdb_column_family_handle_t *handle, int count, const char *const keys[],
